...
import InAppBottom from "./InAppBottom";
...
const Intern = () => {
  ...
  {/* Start of InApp Bottom */}

      {/* <section
        id="bottom-navigation"
        className="block inset-x-0 bottom-0 z-10 bg-white shadow"
      >
        <div id="tabs" className="flex justify-between">
          ...
          >
            ...
            <span className="tab tab-explore block text-xs">Support Team</span>
          </a>
          <a
            href="#"
            className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1"
          >
            ...
            <span className="tab tab-whishlist block text-xs">Comment</span>
          </a>
          <a
            href="#"
            className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1"
          >
            ...
            <span className="tab tab-account block text-xs">Log Book</span>
          </a>
          <a
            href="#"
            className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1"
          >
            ...
            <span className="tab tab-account block text-xs">User Profile</span>
          </a>
          <a
            href="#"
            className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1"
